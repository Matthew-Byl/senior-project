...
CPUs are able to automatically manage a memory hierarchy, because the small number of threads access relatively few new memory locations per cycle. On a data-parallel architecture like a GPU, the thousands of threads can pull in massive amounts of data per cycle, making caching impossible. Therefore, the burden is shifted to the programmer to organize which data should be stored in which levels of the memory hierarchy.
...
\lstinputlisting{../README.markdown}
...
\lstinputlisting{../cl_test/CLArgument.cpp}

\subsubsection*{cl\_test/CLArgument.h}
\lstinputlisting{../cl_test/CLArgument.h}

\subsubsection*{cl\_test/CLContext.cpp}
\lstinputlisting{../cl_test/CLContext.cpp}

\subsubsection*{cl\_test/CLContext.h}
\lstinputlisting{../cl_test/CLContext.h}

\subsubsection*{cl\_test/CLFunction.cpp}
\lstinputlisting{../cl_test/CLFunction.cpp}

\subsubsection*{cl\_test/CLFunction.h}
\lstinputlisting{../cl_test/CLFunction.h}

\subsubsection*{cl\_test/CLIncludes.h}
\lstinputlisting{../cl_test/CLIncludes.h}

\subsubsection*{cl\_test/CLKernel.cpp}
\lstinputlisting{../cl_test/CLKernel.cpp}

\subsubsection*{cl\_test/CLKernel.h}
\lstinputlisting{../cl_test/CLKernel.h}

\subsubsection*{cl\_test/examples/Makefile}
\lstinputlisting{../cl_test/examples/Makefile}

\subsubsection*{cl\_test/examples/README}
\lstinputlisting{../cl_test/examples/README}

\subsubsection*{cl\_test/examples/vector\_add.cl}
\lstinputlisting{../cl_test/examples/vector_add.cl}

\subsubsection*{cl\_test/examples/vector\_add.cpp}
\lstinputlisting{../cl_test/examples/vector_add.cpp}

\subsubsection*{cl\_test/KernelGenerator.cpp}
\lstinputlisting{../cl_test/KernelGenerator.cpp}

\subsubsection*{cl\_test/KernelGenerator.h}
\lstinputlisting{../cl_test/KernelGenerator.h}

\subsubsection*{cl\_test/Makefile}
\lstinputlisting{../cl_test/Makefile}

\subsubsection*{cl\_test/README}
\lstinputlisting{../cl_test/README}

\subsection{kalah}
\subsubsection*{kalah/board.c}
\lstinputlisting{../kalah/board.c}

\subsubsection*{kalah/board.h}
\lstinputlisting{../kalah/board.h}

\subsubsection*{kalah/depths.h}
\lstinputlisting{../kalah/depths.h}

\subsubsection*{kalah/evaluate.c}
\lstinputlisting{../kalah/evaluate.c}

\subsubsection*{kalah/evaluate.h}
\lstinputlisting{../kalah/evaluate.h}

\subsubsection*{kalah/kalah\_player.h}
\lstinputlisting{../kalah/kalah_player.h}

\subsubsection*{kalah/main.cpp}
\lstinputlisting{../kalah/main.cpp}

\subsubsection*{kalah/Makefile}
\lstinputlisting{../kalah/Makefile}

\subsubsection*{kalah/opencl\_player.cl.in}
\lstinputlisting{../kalah/opencl_player.cl.in}

\subsubsection*{kalah/opencl\_player.cpp}
\lstinputlisting{../kalah/opencl_player.cpp}

\subsubsection*{kalah/opencl\_player.h}
\lstinputlisting{../kalah/opencl_player.h}

\subsubsection*{kalah/opencl\_player\_tests.cpp}
\lstinputlisting{../kalah/opencl_player_tests.cpp}

\subsubsection*{kalah/README}
\lstinputlisting{../kalah/README}

\subsubsection*{kalah/simple\_players.c}
\lstinputlisting{../kalah/simple_players.c}

\subsubsection*{kalah/simple\_players.h}
\lstinputlisting{../kalah/simple_players.h}

\subsubsection*{kalah/tree\_array.c}
\lstinputlisting{../kalah/tree_array.c}

\subsubsection*{kalah/tree\_array.h}
\lstinputlisting{../kalah/tree_array.h}

\subsubsection*{kalah/types.h}
\lstinputlisting{../kalah/types.h}

\subsection{local\_malloc}
\subsubsection*{local\_malloc/AllocationAST.cpp}
\lstinputlisting{../local_malloc/AllocationAST.cpp}

\subsubsection*{local\_malloc/AllocationAST.h}
\lstinputlisting{../local_malloc/AllocationAST.h}

\subsubsection*{local\_malloc/CallGraph.cpp}
\lstinputlisting{../local_malloc/CallGraph.cpp}

\subsubsection*{local\_malloc/CallGraph.h}
\lstinputlisting{../local_malloc/CallGraph.h}

\subsubsection*{local\_malloc/ClangInterface.cpp}
\lstinputlisting{../local_malloc/ClangInterface.cpp}

\subsubsection*{local\_malloc/ClangInterface.h}
\lstinputlisting{../local_malloc/ClangInterface.h}

\subsubsection*{local\_malloc/embed\_src.sh}
\lstinputlisting{../local_malloc/embed_src.sh}

\subsubsection*{local\_malloc/example/example.cl}
\lstinputlisting{../local_malloc/example/example.cl}

\subsubsection*{local\_malloc/example/example.cpp}
\lstinputlisting{../local_malloc/example/example.cpp}

\subsubsection*{local\_malloc/example/Makefile}
\lstinputlisting{../local_malloc/example/Makefile}

\subsubsection*{local\_malloc/example/README}
\lstinputlisting{../local_malloc/example/README}

\subsubsection*{local\_malloc/functions.cpp}
\lstinputlisting{../local_malloc/functions.cpp}

\subsubsection*{local\_malloc/local\_malloc.h}
\lstinputlisting{../local_malloc/local_malloc.h}

\subsubsection*{local\_malloc/LocalMallocRewriter.cpp}
\lstinputlisting{../local_malloc/LocalMallocRewriter.cpp}

\subsubsection*{local\_malloc/LocalMallocRewriter.h}
\lstinputlisting{../local_malloc/LocalMallocRewriter.h}

\subsubsection*{local\_malloc/main.cpp}
\lstinputlisting{../local_malloc/main.cpp}

\subsubsection*{local\_malloc/Makefile}
\lstinputlisting{../local_malloc/Makefile}

\subsubsection*{local\_malloc/README}
\lstinputlisting{../local_malloc/README}

\subsubsection*{local\_malloc/RewriterAST.cpp}
\lstinputlisting{../local_malloc/RewriterAST.cpp}

\subsubsection*{local\_malloc/RewriterAST.h}
\lstinputlisting{../local_malloc/RewriterAST.h}

\subsubsection*{local\_malloc/test0.cl}
\lstinputlisting{../local_malloc/test0.cl}

\subsubsection*{local\_malloc/test1.cl}
\lstinputlisting{../local_malloc/test1.cl}

\subsubsection*{local\_malloc/test2.cl}
\lstinputlisting{../local_malloc/test2.cl}

\subsection{raytracer}
\subsubsection*{raytracer/CLRenderer.cpp}
\lstinputlisting{../raytracer/CLRenderer.cpp}

\subsubsection*{raytracer/CLRenderer.h}
\lstinputlisting{../raytracer/CLRenderer.h}

\subsubsection*{raytracer/Makefile}
\lstinputlisting{../raytracer/Makefile}

\subsubsection*{raytracer/objects.h}
\lstinputlisting{../raytracer/objects.h}

\subsubsection*{raytracer/raytracer.cl.in}
\lstinputlisting{../raytracer/raytracer.cl.in}

\subsubsection*{raytracer/README}
\lstinputlisting{../raytracer/README}

\subsubsection*{raytracer/ui.cpp}
\lstinputlisting{../raytracer/ui.cpp}

\subsection{societies}
\subsubsection*{societies/1-resource-extraction/effort.cl}
\lstinputlisting{../societies/1-resource-extraction/effort.cl}

\subsubsection*{societies/1-resource-extraction/Makefile}
\lstinputlisting{../societies/1-resource-extraction/Makefile}

\subsubsection*{societies/1-resource-extraction/README}
\lstinputlisting{../societies/1-resource-extraction/README}

\subsubsection*{societies/1-resource-extraction/resource-extraction.cl.in}
\lstinputlisting{../societies/1-resource-extraction/resource-extraction.cl.in}

\subsubsection*{societies/1-resource-extraction/resource-extraction.cpp}
\lstinputlisting{../societies/1-resource-extraction/resource-extraction.cpp}

\subsubsection*{societies/1-resource-extraction/resource-extraction.h}
\lstinputlisting{../societies/1-resource-extraction/resource-extraction.h}

\subsubsection*{societies/1-resource-extraction/tests/effort-curve.cpp}
\lstinputlisting{../societies/1-resource-extraction/tests/effort-curve.cpp}

\subsubsection*{societies/1-resource-extraction/tests/effort-curve.plot}
\lstinputlisting{../societies/1-resource-extraction/tests/effort-curve.plot}

\subsubsection*{societies/1-resource-extraction/tests/gain-per-minute.cpp}
\lstinputlisting{../societies/1-resource-extraction/tests/gain-per-minute.cpp}

\subsubsection*{societies/1-resource-extraction/tests/gain-per-minute.plot}
\lstinputlisting{../societies/1-resource-extraction/tests/gain-per-minute.plot}

\subsubsection*{societies/1-resource-extraction/tests/Makefile}
\lstinputlisting{../societies/1-resource-extraction/tests/Makefile}

\subsubsection*{societies/1-resource-extraction/tests/marginal-utility.cpp}
\lstinputlisting{../societies/1-resource-extraction/tests/marginal-utility.cpp}

\subsubsection*{societies/1-resource-extraction/tests/marginal-utility.plot}
\lstinputlisting{../societies/1-resource-extraction/tests/marginal-utility.plot}

\subsubsection*{societies/1-resource-extraction/tests/run\_charts.sh}
\lstinputlisting{../societies/1-resource-extraction/tests/run_charts.sh}

\subsubsection*{societies/1-resource-extraction/tests/run\_tests.sh}
\lstinputlisting{../societies/1-resource-extraction/tests/run_tests.sh}

\subsubsection*{societies/1-resource-extraction/tests/utility.cpp}
\lstinputlisting{../societies/1-resource-extraction/tests/utility.cpp}

\subsubsection*{societies/1-resource-extraction/tests/utility.plot}
\lstinputlisting{../societies/1-resource-extraction/tests/utility.plot}

\subsubsection*{societies/1-resource-extraction/utility.cl}
\lstinputlisting{../societies/1-resource-extraction/utility.cl}

\subsubsection*{societies/2-trading/Makefile}
\lstinputlisting{../societies/2-trading/Makefile}

\subsubsection*{societies/2-trading/menu.cl}
\lstinputlisting{../societies/2-trading/menu.cl}

\subsubsection*{societies/2-trading/README}
\lstinputlisting{../societies/2-trading/README}

\subsubsection*{societies/2-trading/tests/Makefile}
\lstinputlisting{../societies/2-trading/tests/Makefile}

\subsubsection*{societies/2-trading/tests/menu\_test.cl.in}
\lstinputlisting{../societies/2-trading/tests/menu_test.cl.in}

\subsubsection*{societies/2-trading/tests/menu\_test.cpp}
\lstinputlisting{../societies/2-trading/tests/menu_test.cpp}

\subsubsection*{societies/2-trading/tests/trading\_test.cpp}
\lstinputlisting{../societies/2-trading/tests/trading_test.cpp}

\subsubsection*{societies/2-trading/tests/valuation\_test.cl.in}
\lstinputlisting{../societies/2-trading/tests/valuation_test.cl.in}

\subsubsection*{societies/2-trading/tests/valuation\_test.cpp}
\lstinputlisting{../societies/2-trading/tests/valuation_test.cpp}

\subsubsection*{societies/2-trading/trading.cl.in}
\lstinputlisting{../societies/2-trading/trading.cl.in}

\subsubsection*{societies/2-trading/trading.cpp}
\lstinputlisting{../societies/2-trading/trading.cpp}

\subsubsection*{societies/2-trading/trading.h}
\lstinputlisting{../societies/2-trading/trading.h}

\subsubsection*{societies/2-trading/valuation.cl}
\lstinputlisting{../societies/2-trading/valuation.cl}

\subsubsection*{societies/config/config.cpp}
\lstinputlisting{../societies/config/config.cpp}

\subsubsection*{societies/config/config.h}
\lstinputlisting{../societies/config/config.h}

\subsubsection*{societies/README}
\lstinputlisting{../societies/README}

\subsubsection*{societies/util/choose\_thread.cl}
\lstinputlisting{../societies/util/choose_thread.cl}

\subsubsection*{societies/util/max\_min.cl}
\lstinputlisting{../societies/util/max_min.cl}

\subsubsection*{societies/util/test/choose\_thread\_tester.cl.in}
\lstinputlisting{../societies/util/test/choose_thread_tester.cl.in}

\subsubsection*{societies/util/test/choose\_thread\_tester.cpp}
\lstinputlisting{../societies/util/test/choose_thread_tester.cpp}

\subsubsection*{societies/util/test/choose\_thread\_tester.plot}
\lstinputlisting{../societies/util/test/choose_thread_tester.plot}

\subsubsection*{societies/util/test/choose\_thread\_tester.sh}
\lstinputlisting{../societies/util/test/choose_thread_tester.sh}

\subsubsection*{societies/util/test/Makefile}
\lstinputlisting{../societies/util/test/Makefile}

\subsubsection*{societies/util/test/max\_min\_tester.cl.in}
\lstinputlisting{../societies/util/test/max_min_tester.cl.in}

\subsubsection*{societies/util/test/max\_min\_tester.cpp}
\lstinputlisting{../societies/util/test/max_min_tester.cpp}

\subsubsection*{societies/util/test/n\_minimum\_tester.cl.in}
\lstinputlisting{../societies/util/test/n_minimum_tester.cl.in}

\subsubsection*{societies/util/test/n\_minimum\_tester.cpp}
\lstinputlisting{../societies/util/test/n_minimum_tester.cpp}

\subsubsection*{societies/util/types.h}
\lstinputlisting{../societies/util/types.h}
%\fi
\end{document}
